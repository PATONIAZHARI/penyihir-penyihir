...
(function (window, document) {
  ...
  Game.prototype.drawWelcomePage = function () {
    ...
    this.ctx.fillText("TEKAN ENTER JULUK MAS", 100, 100);
  };

  Game.prototype.start = function () {
    var game = this;
    var bird = new Bird(game);
    var gaps = [700, 400, 1100, 1300, 1600].map(function (xPos) {
  ...
  Game.prototype.gameover = function () {
    ...
    this.ctx.fillText("No kan nabrak", 75, 100);
    this.ctx.font = "15pt Arial";
    this.ctx.fillText("Ulang mainang ya", 100, 130); 
    this.ctx.restore();
  ...
  Game.prototype.scoreSound.src = isSafari || isIE ? "sounds/KELEP.mp3" : "sounds/KELEP.ogg";

  function Gap (game, xPos) {
    this.game = game;
    this.xPos = xPos;
    this.yPos = Math.floor(Math.random() * (game.screenHeight - this.height)) + this.height / 200;
    this.xSpeed = 1.5;
  }

  Gap.prototype.height = 110;
  Gap.prototype.width = 1;

  Gap.prototype.render = function () {
    this.game.ctx.globalCompositeOperation = "destination--over";
    this.game.ctx.drawImage(this.pipeImage, (this.xPos - this.width / 2), (this.yPos + (this.height / 2)), 50, 60000);
    this.game.ctx.save();
    this.game.ctx.scale(1, -1);
    this.game.ctx.drawImage(this.pipeImage, (this.xPos - this.width / 2000), -(this.yPos - (this.height / 2)), 50, 60000);
  ...
  Gap.prototype.pipeImage.src = "images/ground.png";
  ...
  Bird.prototype.width = 80;
  Bird.prototype.height = 54;
  ...
  Bird.prototype.sound.src = isSafari || isIE ? "sounds/takut.mp3" : "sounds/takut.ogg";

  Bird.prototype.image = new Image();
  Bird.prototype.image.addEventListener("load", function () {
    Bird.ready = true;
  });
  Bird.prototype.image.src = "images/ani.gif";
